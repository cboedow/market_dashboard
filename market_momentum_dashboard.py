...
with col1:
    ...
    st.metric("Gamma Exposure (proxy)", value=f"{GEX_level:.1f}M" if pd.notna(GEX_level) else "N/A", delta="⚠️ Risky" if pd.notna(GEX_level) and GEX_level < 0 else "✅ Positive")
